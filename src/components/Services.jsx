const services = [
    {
      ...
      description:
        "Optimiza tu flujo de trabajo con metodologías ágiles, asegurando entregas eficientes y equipos alineados.",
      icon: "🚀",
    },
    {
      title: "Liderazgo en Producto",
      description:
    ...
    },
    {
      ...
      description:
        "Transforma ideas en productos rentables con frameworks de validación y experimentación rápida.",
      icon: "💡",
    },
    {
      title: "Mentoría 1:1",
